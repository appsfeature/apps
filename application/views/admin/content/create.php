                  ...
                  <form name="contentForm" id="contentForm" action=""  method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mb-3">
                           ...
                           <input type="number" placeholder="Enter here" class="form-control" name="ranking" access="false" value="0" id="ranking">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 mb-3">
                            ...
                            <input type="text" placeholder="Enter here" class="form-control" name="description" access="false" id="description">
                        </div>
                    </div>
